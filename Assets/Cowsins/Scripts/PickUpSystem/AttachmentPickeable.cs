...
public class AttachmentPickeable : Pickeable
{
    ...
    public void GetVisuals()
    {
        ...
        {
            Debug.LogError("Attachment Identifier not set-up! Please assign a proper attachment identifier to your existing attachments, otherwise the system won磘 work properly.");
            return;  
        }
